...
public class ProductoAPI extends HttpServlet {
        ...
        try {
            ...
            switch (this.action) {
                ...
                case "updateProducto":
                    ...
                    break;
                case "addImagenBotonProducto":
                    //LOG.info("estoy en editar addImagenBotonProducto<<<<<<<<<<<<<<<<<<<<<");
                    processProducto(this.productoDAO.update(getProducto(request), getParameters(request)), response);
                    break;
                case "deleteProducto":
    ...
    private Producto getProducto(HttpServletRequest request) {
        ...
        //LOG.info("estoy en getProducto(HttpServletRequest requestdddddddddddddddddddddddddd) ");
        if (request.getParameter("action").equals("updateProducto") || request.getParameter("action").equals("addImagenBotonProducto")) {
        ...
        producto.setIdempresa(Integer.parseInt(request.getParameter("txtIdEmpresaER")));
        ...
        producto.setNombreImagenBoton(request.getParameter("nombreImagen"));
    ...
    private HashMap<String, Object> getParameters(HttpServletRequest request) {
        ...
        LOG.info("getparameters ProductoAPI  " + request.getParameter("txtNombreProducto"));
