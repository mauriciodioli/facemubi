...
<html class="no-js" lang="es">
    ...
    <body>
        ...
        <div class="page-container">
            ...
            <div class="main-content">
                ...
                <div class="main-content-inner" style="margin-left: 0px">
                    ...
                    <a href="index"><img style="width: 100%; margin-left: 0px"  src="assets/images/icon/miamiNoche_1.png" alt="logo"></a>
                </div>
            </div>
        ...
        <script src="<%out.print(getServletContext().getContextPath());%>/js_app/app/index.js"></script>
