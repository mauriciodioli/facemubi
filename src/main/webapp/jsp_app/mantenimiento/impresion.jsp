<%-- 
    Document   : impresion
    Created on : 07/11/2019, 18:30:38
    Author     : Mauricio
--%>
...
<html class="no-js" lang="es">
    ...
    <body>
                                    ...
                                    <form id="FrmCategoria">
                                        <div class="row mt-3">
                                            ...
                                            <div class="form-group col-md-3 col-12">
                                                ...
                                                <button type="button" id="btnPruebaCategoria" class="btn btn-primary btn-xs" data-toggle="tooltip" title="Prueba Categoria"><i class="fa fa-plus-square" aria-hidden="true"></i></button>
                                            </div>
                                        </div>
                                    </form>
                                    <div class="row">
        ...
        <script src="<%out.print(getServletContext().getContextPath());%>/js_app/app/impresion.js"></script>
