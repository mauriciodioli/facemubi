                                    ...
                                    <form id="FrmProducto">
                                        <div class="row mt-3">
                                            <div class="form-group col-md-9 col-12">
                                                ...
                                                <input type="hidden" name="txtIdEmpresaER" id="txtIdEmpresaER"  value=<%out.print(((com.jcode.myapp.model.session.Usuario) request.getSession().getAttribute("usuario")).getIdempresa());%>>
